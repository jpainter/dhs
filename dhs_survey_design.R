# load dhs survey
# get the design that corresponds to the variable of interest
# variables may be in childrens, womens (aka individual), or household files
# The file is generally consistent across surveys, but it does vary
...
survey_values = function( .country = "Angola", 
