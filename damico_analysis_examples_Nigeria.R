...
# source_url( "https://raw.github.com/ajdamico/asdfree/master/Demographic%20and%20Health%20Surveys/analysis%20examples.R" , prompt = FALSE , echo = TRUE )
# # # # # # # # # # # # # # #
...
load( "./Nigeria/Standard DHS 2013/Individual Recode.rda" ) # (JP)
...
# create a survey design object (nigeria.dhs.2010.design) with DHS design information
nigeria.dhs.2010.design <- 
  svydesign( 
    ~psu , 
    strata = ~strata , 
    data = x , 
...
# notice the 'nigeria.dhs.2010.design' object used in all subsequent analysis commands
...
svymean( 
  ~surviving.children , 
  design = nigeria.dhs.2010.design ,
  na.rm = TRUE
)
...
# restrict the nigeria.dhs.2010.design object to
# 40-49 year old females only
nigeria.dhs.2010.design.4049 <-
  subset(
    nigeria.dhs.2010.design ,
    v447a %in% 40:49
  )
# now any of the above commands can be re-run
# using the nigeria.dhs.2010.design.4049 object
# instead of the nigeria.dhs.2010.design object
...
svymean( 
  ~v201 , 
  design = nigeria.dhs.2010.design.4049 ,
  na.rm = TRUE
)
