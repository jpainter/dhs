...
```{r}
  ...
  csb_map = csb_mapped_2016 %>%
    ...
    summarise( care_level = max(care_level, na.rm = TRUE))
...
# translate dhs provider categories to csb types 
  ...
  xcsbl$care_level = as.integer( csb_map[ match( 
...
rx_2016 <- read_excel("~/Dropbox/_Malaria/Projects/WMR/Drugs lookup 2016.xlsx")

rx_levels = read_excel("~/Dropbox/_Malaria/Projects/WMR/Drugs lookup 2016.xlsx", sheet = 3) 
 
rx_classes = read_excel("~/Dropbox/_Malaria/Projects/WMR/Drugs lookup 2016.xlsx", sheet = 2) 
```
