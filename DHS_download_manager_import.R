...
# load the text 
y <- readLines( tf )  # not working

###### from http://stackoverflow.com/questions/24723606/scrape-password-protected-website-in-r
...
login <- list(
  amember_login = your.username
 ,amember_pass  = your.password
 ,amember_redirect_url = projects.page
)

GET( handle = handle,  query = login )
POST(handle = handle,  body = login)
GET(handle = handle, projects.page )
...
##### get list of links from download manager #####  JP
link.urls = c(
"http://dhsprogram.com/customcf/legacy/data/download_dataset.cfm?Filename=AOPR51DT.zip&Tp=1&Ctry_Code=AO&surv_id=282&dm=1" ,
"http://dhsprogram.com/customcf/legacy/data/download_dataset.cfm?Filename=AOPR51FL.zip&Tp=1&Ctry_Code=AO&surv_id=282&dm=1" ,
"http://dhsprogram.com/customcf/legacy/data/download_dataset.cfm?Filename=AOPR61DT.zip&Tp=1&Ctry_Code=AO&surv_id=395&dm=1" ,
"http://dhsprogram.com/customcf/legacy/data/download_dataset.cfm?Filename=AOPR61FL.zip&Tp=1&Ctry_Code=AO&surv_id=395&dm=1" ,
"http://dhsprogram.com/customcf/legacy/data/download_dataset.cfm?Filename=AOGE52FL.zip&Tp=2&Ctry_Code=AO&surv_id=282&dm=1" ,
"http://dhsprogram.com/customcf/legacy/data/download_dataset.cfm?Filename=AOGE61FL.zip&Tp=2&Ctry_Code=AO&surv_id=395&dm=1"
  ) 
